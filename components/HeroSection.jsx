...
function HeroSection() {
  return (
    <section className="relative bg-gradient-to-br from-green-50 to-emerald-100 overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-10 container mx-auto px-4 py-8 md:py-16 lg:py-32">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          >
            <motion.div
              ...
              className="inline-flex items-center px-3 py-1 md:px-4 md:py-2 bg-green-100 text-green-800 rounded-full text-xs md:text-sm font-medium mb-4 md:mb-6"
            >
            ...
            <motion.h1
              ...
              className="text-2xl sm:text-3xl md:text-5xl lg:text-7xl font-bold text-gray-900 mb-4 md:mb-6 leading-tight"
            >
              Pure & Organic
            ...
            <motion.p
              ...
              className="text-sm md:text-lg lg:text-xl text-gray-600 mb-6 md:mb-8 max-w-2xl"
            >
            ...
            >
              <Link href="/products">
                <motion.button
                  className="bg-green-600 hover:bg-green-700 text-white font-semibold px-6 py-3 md:px-8 md:py-4 rounded-lg text-base md:text-lg flex items-center justify-center group transition-all duration-300 shadow-lg hover:shadow-xl"
              ...
              <Link href="/about">
                <motion.button
                  className="border-2 border-green-600 text-green-600 hover:bg-green-600 hover:text-white font-semibold px-6 py-3 md:px-8 md:py-4 rounded-lg text-base md:text-lg transition-all duration-300"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                >
                  Learn More
            ...
            <motion.div
              ...
              className="hidden md:grid grid-cols-3 gap-6 mt-8 lg:mt-12"
            >
